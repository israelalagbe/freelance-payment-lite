...
/**
 * Class-field decorator (Stage 3 / TS5 native) that validates `req.query`
 ...
 *
 * Usage:
 *   @ValidateQuery(MyQueryDto)
 *   myHandler = async (req: Request & { dto: MyQueryDto }, res: Response, next: NextFunction) => { ... };
 */
